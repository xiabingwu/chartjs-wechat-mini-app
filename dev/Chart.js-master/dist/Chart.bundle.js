...
},{"10":10,"11":11,"12":12,"13":13,"14":14,"15":15,"16":16,"17":17,"18":18,"19":19,"2":2,"20":20,"21":21,"22":22,"23":23,"24":24,"25":25,"26":26,"27":27,"28":28,"29":29,"3":3,"30":30,"31":31,"32":32,"33":33,"34":34,"4":4,"40":40,"41":41,"42":42,"43":43,"44":44,"5":5,"6":6,"7":7,"8":8,"9":9}],2:[function(require,module,exports){
'use strict';
			...
			helpers.each(itemsToDraw, function(itemToDraw) {
				...
				if (optionTicks.display) {
					...
					if (helpers.isArray(label)) {
						...
						if(!isNaN(label)){//数值，表示y轴
							context.fillText(label, -1*(lalg*5+2), 10);//todo 让label向左偏移一点点，会好看点
						}else{
