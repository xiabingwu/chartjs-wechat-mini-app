...
var srcDir = './dev/Chart.js-master/src/';
var outDir = './dev/Chart.js-master/dist/';
var testDir = './dev/Chart.js-master/test/';
...
function startTest() {
  return [].concat(preTestFiles).concat([
      './dev/Chart.js-master/src/**/*.js',
      './dev/Chart.js-master/test/mockContext.js'
    ]).concat(
      argv.inputs?
        argv.inputs.split(';'):
        testFiles);
...
function librarySizeTask() {
  return gulp.src('./dev/Chart.js-master/dist/Chart.bundle.min.js')
    .pipe(size({
      gzip: true
    }));
}
...
function watchTask() {
  if (util.env.test) {
    return gulp.watch('./dev/Chart.js-master/src/**', ['build', 'unittest', 'unittestWatch']);
  }
  return gulp.watch('./dev/Chart.js-master/src/**', ['build']);
}
